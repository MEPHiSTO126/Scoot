...
export default function HowItWorks() {
  return (
    ...
    <section className="relative py-24 w-full overflow-hidden">
      ...
      <div 
        className="hidden md:block absolute top-[144px] left-0 w-[80vw] lg:w-[75vw] xl:w-[70vw] h-[15px] bg-light-grey z-0"
        style={{ 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {STEPS_DATA.map((step) => (
            <div key={step.id} className="flex flex-col items-center md:items-start text-center md:text-left">
              ...
              {/* Icon Circle */}
              <div className="w-24 h-24 rounded-full bg-scoot-yellow flex items-center justify-center mb-8">
