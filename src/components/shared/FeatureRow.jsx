...
export default function FeatureRow({ 
  ...
  return (
    <div className="relative w-full overflow-hidden py-16 lg:py-24">
      ...
      {/* Decorative Grey Circle */}
      {/* Locked to percentages so it always blooms perfectly from the edge, regardless of screen width */}
      <div 
        className={`absolute top-0 lg:top-1/2 lg:-translate-y-1/2 w-[445px] h-[445px] bg-light-grey rounded-full z-0 
      ...
      {useOuterPattern && (
        <img
          src={pattern}
          alt=""
          className={`absolute z-30 hidden lg:block ${patternPositionClasses}`}
        />
      )}
      ...
      >
        ...
        <div className="flex-1 text-center lg:text-left max-w-[450px]">
          ...
          <p className="mb-10 text-dim-grey">{description}</p>
